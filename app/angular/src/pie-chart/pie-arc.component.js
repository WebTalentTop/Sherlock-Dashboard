...
var PieArcComponent = (function () {
    ...
    PieArcComponent.prototype.loadAnimation = function () {
        var node = d3_selection_1.select(this.element)
            .selectAll('.arc')
        ...
        node
            ...
            var interpolater = d3_interpolate_1.interpolate(copyOfD, copyOfD);
            ...
            .attrTween('d', function (d) {
            this._current = this._current || d;
            var interpolater = d3_interpolate_1.interpolate(this._current, d);
            this._current = interpolater(0);
            return function (t) {
                return arc(interpolater(t));
            };

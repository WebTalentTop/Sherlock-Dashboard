...
var ForceDirectedGraphComponent = (function (_super) {
    ...
    function ForceDirectedGraphComponent() {
        ...
        _this.force = d3_force_1.forceSimulation()
            .force('charge', d3_force_1.forceManyBody())
            .force('collide', d3_force_1.forceCollide(5))
            .force('x', d3_force_1.forceX())
            .force('y', d3_force_1.forceY());
        _this.forceLink = d3_force_1.forceLink().id(function (node) { return node.value; });
        _this.nodes = [];
        _this.links = [];
        _this.activeEntries = [];

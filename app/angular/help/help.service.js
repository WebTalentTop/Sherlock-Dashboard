...
var HelpService = (function () {
    function HelpService(http, tokenService) {
        var _this = this;
        this.http = http;
        this.tokenService = tokenService;
        this.sendMessageUrl = config_1.API_URL + '/sendHelpEmail';
        this.tokenService.getToken()
            .subscribe(function (obj) {
            _this.token = obj;
        }, function (error) { return console.log(error); });
    }
    HelpService.prototype.sendMessage = function (message) {
        ...
        body.set('SECTION', message['SECTION']);
    ...
    HelpService.prototype.handleError = function (res) {
        console.log(res);
        var JSONresponse = res.json();

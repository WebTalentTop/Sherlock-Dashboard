...
var AdminService = (function () {
    function AdminService(http, tokenService) {
        ...
        this.adminUrl = 'http://64.19.207.100:2022/getCompanyGroupUsersForUser';
    ...
    AdminService.prototype.getCompanyGroupUsersforUser = function () {
    ...
    AdminService.prototype.handleError = function (res) {
        console.log(res);
        var JSONresponse = res.json();
